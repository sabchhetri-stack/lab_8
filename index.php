...
<form method="POST" action="deleterecord.php" class="mt-3">
  <div class="row justify-content-center">
    <div class="col-8 d-flex p-0">
      <input type="number" name="client_id" placeholder="Primary Key"
             class="form-control bg-success text-white w-25 text-center rounded-start" required>
      <button type="submit" class="btn btn-danger w-75 rounded-0 rounded-end">
